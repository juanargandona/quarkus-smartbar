...
public class TablesResource implements TablesApi {
    ...
    @Inject
    public TablesResource(TablesService tablesService, TablesRepository tablesRepository, TableMapper mapper) {
    ...
    public Response getTables() {
        List<Table> tables = tablesRepository.listAll();
    ...
    public Response updateTable(Long tableId, ApiTable apiTable) {
        Optional<Table> persistedTable = tablesRepository.findByIdOptional(tableId);
